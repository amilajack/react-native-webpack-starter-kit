...
> This kit was originally used to build and ship, and later extracted from, [Lumpen Radio](https://github.com/jhabdas/lumpen-radio) _early_ in the RN lifecycle. For a list of awesome React Native boilerplates, check out [Awesome React Boilerplates](http://habd.as/awesome-react-boilerplates/#react-native).
